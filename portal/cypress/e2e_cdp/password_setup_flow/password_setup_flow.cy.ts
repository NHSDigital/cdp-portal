...
describe_only_if_password_setup_enabled('Password setup flow tests', () => {
  it('full e2e', () => {
    ...
    cy.get('h1')
      .contains('Sign in to the Common Data Platform (CDP) Portal')
      .should('exist');
