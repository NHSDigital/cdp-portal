import { stringToHash } from '@/app/induction/_components/inductionCookie';
...
export const cdpAgreementUrl = (agreement_id: string = DIGITRIALS) =>
  `/agreement/${agreement_id}`;
...
export const cdp_expected_agreements = {
  local: ['digitrials-fss'],
  dev: ['digitrials-fss'],
  test: ['digitrials-fss'],
  int: ['digitrials-fss'],
};
...
export const DIGITRIALS = cdp_expected_agreements[Cypress.env('BUILD_ENV')][0];

export const cdp_agreement_friendly_names = {
  local: 'Digitrials',
  dev: 'Digitrials',
  test: 'Digitrials',
  int: 'Digitrials',
