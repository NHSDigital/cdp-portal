...
export const analystDescriptionMap: Record<WhiteLabelKey, React.JSX.Element> = {
  SDE: (
    <p>
      ...
      <strong>£435 a month</strong> per agreement. The price will increase to{' '}
      <strong>£472 a month</strong> per agreement from the{' '}
...
export const bothDescriptionMap: Record<WhiteLabelKey, React.JSX.Element> = {
  SDE: (
    <p>
      ...
      users will be charged <strong>£435 a month</strong> per agreement. The
      price will increase to <strong>£472 a month</strong> per agreement from
      the <strong>1 April 2026.</strong>
    </p>
  ),
