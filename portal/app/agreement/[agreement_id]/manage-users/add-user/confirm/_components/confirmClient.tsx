...
type CreateOneUserState = {
  error?: string;
  success?: boolean;
};

const initial_state: CreateOneUserState = {
  error: undefined,
  success: false,
};
...
export interface ConfirmClientProps {
  ...
  agreement_id: string;
  createOneUserNoJS: (
    previous_state: CreateOneUserState,
    form_data: FormData,
  ) => Promise<CreateOneUserState> | CreateOneUserState;
...
export default function ConfirmClient({
  ...
  const [state, createOneUserNoJSFormAction] = useActionState(
    createOneUserNoJS,
    initial_state,
  );
  ...
  return (
    <>
      ...
      <AcceptAndConfirmForm
        ...
        error={combined_error ? combined_error : ''}
