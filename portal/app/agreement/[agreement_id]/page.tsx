...
export default async function AgreementPage({ params }: IAgreementProps) {
      ...
      <ul className='nhsuk-grid-row nhsuk-card-group'>
        ...
        {launchVDICard && (
          <ServiceCard
            ...
            width={cardColumnWidth}
            cypress_id='launch-virtual-desktop-card'
          />
        )}
        {uploadRefDataCard && (
          <ServiceCard
            ...
            width={cardColumnWidth}
            cypress_id='upload-ref-data-card'
          />
        )}
        {guidanceCard && (
          <ServiceCard
