...
describe('confirmClient tests', () => {
  ...
  const baseUser: UserToAdd = {
    first_name: 'bob',
    last_name: 'bobbity',
    email: 'test@test.com',
    role: 'chief lama groomer',
    user_id: '123go!',
  };
  ...
  it('renders confirm view with correct content', () => {
    ...
    const para2 = screen.getByText(/For more information, visit/i).closest('p');
    expect(para2).toHaveTextContent('For more information, visit');
    expect(para2).toHaveTextContent(
